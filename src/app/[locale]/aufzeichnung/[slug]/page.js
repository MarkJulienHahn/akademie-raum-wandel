...
import AufzeichnungSingle from "../../../../../components/Aufzeichnung/AufzeichnungSingle";
...
export default async function page(params) {
  ...
  return (
    <main>
      <div>{params.slug}</div>
      <AufzeichnungSingle angebot={angebot[0]} angebote={angebote} slug={params.params.slug} />
    </main>
  );
}
